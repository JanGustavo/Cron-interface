...
const camelToPascal = (str: string): string => {
  ...
  if (str === 'httpMethod') return 'http_method';
  if (str === 'projectId') return 'project_id';
  if (str === 'projectName') return 'project_name';
  if (str === 'nextRunAt') return 'next_run_at';
  ...
  if (str === 'triggeredAt') return 'triggered_at';
  if (str === 'startedAt') return 'started_at';
  if (str === 'finishedAt') return 'finished_at';
  if (str === 'httpStatus') return 'http_status';
